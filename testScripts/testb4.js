...
corporateWebsiteHeader.prototype = {
  ...
  _renderMobileLoginNavItem: function (context, menuItems) {
    console.log("Start rendering login btn in mb");
    ...
    console.log(existingLogin, "existing login btn");
    if (existingLogin) {
    ...
    if (!mobileRightView) {
      ...
      console.log(
        wDropdownDiv,
        "wDropdownDiv after appending icon and login btn"
      );
      // corporatenavDiv.appendChild(loginDropdownDiv);
  ...
  `;
      ...
      menuDropdownList3Nav.appendChild(layoutGridDiv);
      console.log(menuDropdownList3Nav, "menuDropdownList3Nav");
      wDropdownDiv.appendChild(menuDropdownList3Nav);
      console.log(wDropdownDiv, "wDropdownDiv after appending menulist");
      loginDropdownDiv.appendChild(wDropdownDiv);
      mobileRightView.appendChild(loginDropdownDiv);
      console.log(mobileRightView, "right-view-mb");
    }
  },
