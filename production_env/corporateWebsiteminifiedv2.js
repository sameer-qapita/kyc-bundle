    ...
    o.prototype = {
      ...
      _showUserLoggedInNav: function e(t) {
        var n = document.querySelectorAll(
            "#".concat(t.outreachNavItemsSelector)
          ),
      ...
      _showUserLoggedOutNav: function e(t) {
        ...
        if (
          ...
          this._renderMobileLoginNavItem(t, i),
          this._removeMobileCogwheelIcon(t),
          this._renderLoginDemoNavItem(t, i),
          window.location.pathname.includes("/outreach"))
        ) {
          var a = document.querySelector("#".concat(t.signupOrDemoSelector));
          (a.innerText = "Signup"), (a.href = "/outreach/investor/signup");
        } else {
      ...
      _renderCogWheelMenu: function e(t) {
        ...
        if (
          ...
          m.classList.add("omp-submenu-link"),
            (m.href = "".concat(window.location.origin, "/outreach/users")),
            (m.textContent = "User Details"),
            s.appendChild(m);
      ...
      _renderManage: function e(t) {
        ...
        var u,
          m = l;
        function v() {
          m.classList.toggle("w--open");
          var e = m.classList.contains("w--open");
      ...
      _renderListings: function e() {
        ...
        (n.id = "openmarketnav"),
          (n.className = "openmarketnav investorlogged");
        var o = document.createElement("a"),
          a;
      ...
      _renderLoginDemoNavItem: function e(t, n) {
        ...
        u.classList.add("w-layout-grid", "menu-dropdown-grid3"),
          n.forEach(function (e) {
            var t = document.createElement("div");
