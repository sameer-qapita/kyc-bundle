...
corporateWebsiteHeader.prototype = {
  ...
  _showUserLoggedOutNav: function (context) {
    if (context.userInfo) {
      console.log(context.userInfo.role, "role");
    }
    var openMarketNav = document.querySelectorAll(
      `#${context.outreachNavItemsSelector}`
    );
  ...
  _renderCogWheelMenu: function (context) {
    function createCogWheelIcon() {
      ...
      if (!rightViewMB) {
        ...
        console.log(navBarItemsList, "create cogWheel executed");
      }
    }
    ...
    function removeCogWheelIcon() {
      ...
      console.log(rightCogWheel, "desktop so remove cog");
      if (rightCogWheel) {
    ...
    console.log("script ends at a window eventlistener");
  ...
  _refreshCogWheel: function (context) {
    ...
    if (cogWheelMB) {
      cogWheelMB.addEventListener("touchstart", () => {
        console.log(cogWheelMB, "touch triggered");
        this._renderCogWheelMenu(context);
  ...
  _renderLoginDemoNavItem: function (context) {
    ...
    console.log("renderLoginDemoNavItem");
...
`;
    ...
    const webflowNavItemsList = document.querySelector(".nav-menu.w-nav-menu");
    console.log(webflowNavItemsList);
    ...
    loginDropdownDiv.addEventListener("click", function () {
      ...
      console.log(menuDropList3, "menudroplist3");
  ...
  _removeLoginDemoNavItem: function () {
    ...
    console.log("_removeLoginDemoNavItem");
  },
};

function updateUserInfoInContext(userInfo) {
  console.log(userInfo, "Updating userInfo in context");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  console.log(userInfo, "Loaded userInfo on DOMContentLoaded");
...
document.addEventListener(context.userInfoChangedEventListner, ({ detail }) => {
  if (detail && detail.name && detail.role && detail.isLoggedIn !== undefined) {
    ...
    console.log(detail, "Updated userInfo in localStorage");
